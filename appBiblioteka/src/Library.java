public class Library {
    public static void main(String[] args) {
        ...
        Book book1 = new Book("W pustyni i w puszczy", "Henryk Sienkiewicz", 2010, 458, "Greg", "9788373271890");
        Book book2 = new Book("Java. Efektywne programowanie. Wydanie II", "Joshua Bloch", 2009, 352, "Helion",
                "9788324620845");
        Book book3 = new Book("SCJP Sun Certified Programmer for Java 10 Study Guide", "Bert Bates, Katherine Sierra",
